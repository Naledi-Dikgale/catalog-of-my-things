...
```sh
  ...
  git clone https://github.com/Naledi-Dikgale/catalog-of-my-things.git
```
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/catalog-of-my-things/issues).
